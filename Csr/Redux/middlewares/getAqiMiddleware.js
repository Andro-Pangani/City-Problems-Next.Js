...
import { aqiLevelArray, aqiMarkerSetup, setAqiColor } from "../../Components/functions/aqi/aqiFunctions";
          ...
          if (!data || data.length === 0) {
           ...
           // console.log('!!!!!!!!AqiData ',data);
            ...
            if (data) {
                ...
                aqidata[station.settlement_en] = !aqidata[station.settlement_en]
                  ...
                  if(station.stationequipment_set){
                   station.stationequipment_set.map(substance => {
                    ...
                    if(substance.data1hour_set && substance.data1hour_set.length !== 0){
              ...
              console.log("AQIIIIIIIII Data", aqidata);
